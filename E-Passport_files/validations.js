...
function checkPassword(inputField,outputField,formName,hideField)
{
	...
	{
		 $("#"+outputField).text("Password must be at least 8 characters and must contain an upper case character, a lower case character, a numeric character, and a special character !@#$%^&*()");
	     setTimeout ( $("#"+formName+"\\:"+hideField).hide(), 100);
